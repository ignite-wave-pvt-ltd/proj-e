...
// // //         { name: "Users List", href: "/admin/users", icon: "📋" },
...
// // //                     to={item.href}
// // //                     className={({ isActive }) =>
// // //                       `flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors duration-200 hover:bg-blue-50 hover:text-blue-600 ${
...
// // //                       className={`flex items-center justify-between w-full px-4 py-3 text-gray-700 rounded-lg transition-colors duration-200 hover:bg-blue-50 hover:text-blue-600 ${
...
// // //                               to={subItem.href}
// // //                               className={({ isActive }) =>
// // //                                 `flex items-center px-4 py-2 text-sm text-gray-600 rounded-lg transition-colors duration-200 hover:bg-blue-50 hover:text-blue-600 ${
// // //                                   isActive
...
// //         {
// //           name: "Create College",
// //           href: "/superadmin/create-college",
// //           icon: "🏫",
// //         },
// //         { name: "Manage Colleges", href: "/superadmin/colleges", icon: "📋" },
// //         // { name: "Users Management", href: "/superadmin/users", icon: "👥" },
// //         // { name: "Roles & Permissions", href: "/superadmin/roles", icon: "🔐" },
// //         // { name: "Reports", href: "/superadmin/reports", icon: "📈" },
// //       ],
// //     },

// //     // 🔹 COLLEGE ADMIN MODULES
// //     {
// //       name: "College Admin",
// //       icon: "🏫",
// //       type: "dropdown",
...
// //         { name: "Departments", href: "/college/departments", icon: "🏢" },
// //         { name: "Faculty & Staff", href: "/college/faculty", icon: "👩‍🏫" },
// //         { name: "Students", href: "/college/students", icon: "🎓" },
// //         { name: "Courses", href: "/college/courses", icon: "📚" },
// //         { name: "Fees Setup", href: "/college/fees", icon: "💰" },
// //         { name: "Reports", href: "/college/reports", icon: "📑" },
// //       ],
// //     },
...
// //           icon: "📊",
// //         },
// //         { name: "Admission Setup", href: "/admission/setup", icon: "⚙️" },
// //         { name: "Courses & Intake", href: "/admission/courses", icon: "📘" },
// //         {
...
// //           icon: "📁",
// //         },
// //         { name: "Offer Letters", href: "/admission/offers", icon: "📨" },
// //         { name: "Fee Payment", href: "/admission/payments", icon: "💳" },
// //         { name: "Enrollment", href: "/admission/enrollment", icon: "🎓" },
// //         { name: "Admission Reports", href: "/admission/reports", icon: "📈" },
// //       ],
// //     },
...
// //           icon: "📊",
// //         },
// //         { name: "HOD Panel", href: "/department/hod", icon: "🧑‍💼" },
// //         {
// //           name: "Faculty Assignments",
// //           href: "/department/faculty-assign",
// //           icon: "📋",
// //         },
// //         { name: "Class Scheduling", href: "/department/schedule", icon: "📅" },
// //         {
// //           name: "Internal Marks",
...
// //       type: "dropdown",
// //       items: [
// //         { name: "Take Attendance", href: "/attendance/mark", icon: "✅" },
// //         { name: "View Attendance", href: "/attendance/view", icon: "👀" },
// //         { name: "Attendance Reports", href: "/attendance/reports", icon: "📊" },
// //       ],
// //     },
...
// //     //   type: "dropdown",
// //     //   items: [
// //     //     { name: "Exam Scheduler", href: "/exam/schedule", icon: "🗓️" },
// //     //     { name: "Hall Tickets", href: "/exam/halltickets", icon: "🎟️" },
// //     //     { name: "Result Entry", href: "/exam/results-entry", icon: "✏️" },
// //     //     { name: "Result Approval", href: "/exam/result-approval", icon: "✅" },
// //     //     { name: "Publish Results", href: "/exam/publish", icon: "📢" },
// //     //   ],
// //     // },
...
// //         { name: "Room Allocation", href: "/hostel/rooms", icon: "🛏️" },
// //         { name: "Attendance", href: "/hostel/attendance", icon: "🗒️" },
...
// //         { name: "Issue / Return", href: "/library/issue", icon: "📦" },
...
// //         { name: "Company List", href: "/placement/companies", icon: "🏢" },
...
// //         { name: "Drivers", href: "/transport/drivers", icon: "🚗" },
// //         { name: "Student Tracking", href: "/transport/tracking", icon: "📍" },
// //         { name: "Reports", href: "/transport/reports", icon: "📈" },
// //       ],
// //     },
...
// //         { name: "Exams & Results", href: "/student/results", icon: "🧾" },
...
// //         { name: "Child Details", href: "/parent/child", icon: "🧒" },
// //         { name: "Attendance", href: "/parent/attendance", icon: "📋" },
// //         { name: "Fees & Payments", href: "/parent/fees", icon: "💰" },
...
//         { name: "Profile", href: "/faculty/profile", icon: "👤" },
//         { name: "Attendance", href: "/faculty/attendance", icon: "🗓️" },
//         { name: "Marks & Grading", href: "/faculty/marks", icon: "✏️" },
...
//         { name: "Task Tracker", href: "/staff/tasks", icon: "🗂️" },
//         { name: "Communication", href: "/staff/communication", icon: "💬" },
//       ],
//     },
...
//         { name: "Attendance", href: "/student/attendance", icon: "📋" },
//         { name: "Courses & Enrollment", href: "/student/courses", icon: "📘" },
//         {
...
//       items: [
//         { name: "Dashboard", href: "/parent/dashboard", icon: "📊" },
//         { name: "Children Overview", href: "/parent/children", icon: "🧒" },
//         { name: "Attendance", href: "/parent/attendance", icon: "📋" },
//         { name: "Exams & Results", href: "/parent/results", icon: "🧾" },
//         { name: "Fees & Payments", href: "/parent/fees", icon: "💰" },
...
//     {
//       name: "Transport Management (TRANSPORT STAFF / DRIVERS)",
//       icon: "🚌",
//       type: "dropdown",
//       items: [
//         { name: "Dashboard", href: "/transport/dashboard", icon: "📊" },
//         { name: "Vehicle & Routes", href: "/transport/routes", icon: "🗺️" },
//         { name: "Driver Profiles", href: "/transport/drivers", icon: "🚗" },
...
//     {
//       name: "Hostel Management (HOSTEL WARDEN / STAFF)",
//       icon: "🏠",
//       type: "dropdown",
//       items: [
...
//         },
//         { name: "Visitor Logs", href: "/hostel/visitors", icon: "📖" },
//         { name: "Notices", href: "/hostel/notices", icon: "📢" },
//       ],
//     },
...
//       items: [
//         { name: "Dashboard", href: "/placement/dashboard", icon: "📊" },
//         { name: "Company Directory", href: "/placement/companies", icon: "🏢" },
//         { name: "Job Postings", href: "/placement/jobs", icon: "📋" },
//         {
//           name: "Student Applications",
//           href: "/placement/applications",
...
//         { name: "Issue / Return", href: "/library/issue", icon: "📦" },
//         { name: "Fines & Payments", href: "/library/fines", icon: "💵" },
//         { name: "E-Library", href: "/library/ebooks", icon: "💾" },
...
//         { name: "Support Tickets", href: "/it/tickets", icon: "🎟️" },
//         { name: "System Logs", href: "/it/logs", icon: "🧾" },
//         { name: "API & Integrations", href: "/it/api", icon: "🔌" },
//         { name: "Storage Management", href: "/it/storage", icon: "💾" },
...
//           icon: "🗓️",
//         },
//         { name: "Reports", href: "/counseling/reports", icon: "📈" },
  ...
  const navigation = [
    // 🏠 DASHBOARD
    {
      ...
      items: [
        ...
        { name: "Announcements & Alerts", href: "/announcements", icon: "📢" },
        { name: "Calendar / Upcoming Events", href: "/calendar", icon: "📅" },
        { name: "Quick Links / Shortcuts", href: "/quick-links", icon: "⚡" },
      ],
    },
